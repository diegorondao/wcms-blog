...
<html lang="en">
  <head>
    ...
    <!-- Bootstrap core CSS -->
    <link href="<?= BLOG_SITE_URL ?>/assets/css/bootstrap.min.css" rel="stylesheet">

    <!-- Custom styles for this template -->
    <link href="<?= BLOG_SITE_URL ?>/assets/css/style.css" rel="stylesheet">
  ...
  <body>
    ...
    <div class="blog-masthead">
      <div class="container">
        <nav class="blog-nav">
          <a class="blog-nav-item <?php if ( is_menu_selected('index') ) echo 'active' ?>" href="<?= BLOG_BASE_URL; ?>">Home</a>
          <?php 
          	$menu_pages = blog_get_menu_pages( 6 );
          ...
          ?>
            ...
            <ul class="nav navbar-nav navbar-right">
              <li><a href="<?= do_action(''); ?>">Admin</a></li>
          </ul>
        </nav>
      </div>
    </div>
